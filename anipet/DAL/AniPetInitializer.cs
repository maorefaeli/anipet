    ...
    public class AnipetInitializer : System.Data.Entity.DropCreateDatabaseAlways<DBContext>
    {
        protected override void Seed(DBContext context)
        {
            ...
            var users = new List<User>
            {
                ...
                new User{Id=2,IsAdmin=true,Password="HelloWorld1!",Username="Guy",FavoriteProduct=context.Products.Find(1)},
                new User{Id=3,IsAdmin=true,Password="Ashkenazi",Username="Alon",FavoriteProduct=context.Products.Find(4)},
                new User{Id=4,IsAdmin=true,Password="BarRefaeli",Username="Maor",FavoriteProduct=context.Products.Find(5)},
                new User{Id=5,IsAdmin=false,Password="Losers",Username="Hapoel",FavoriteProduct=context.Products.Find(5)},
            };
